...
bool RenderTarget::Init(ID3D11Device* device, float screenNear, float screenDepth)
{
	...
	COM_ERROR_IF_FAILED(hr, "render target CreateTexture2D.");
	...
	COM_ERROR_IF_FAILED(hr, "render target CreateRenderTargetView.");
	...
	COM_ERROR_IF_FAILED(hr, "render target CreateShaderResourceView.");
	...
	COM_ERROR_IF_FAILED(hr, "render target CreateTexture2D depth.");
	...
	COM_ERROR_IF_FAILED(hr, "render target CreateDepthStencilView.");
